...
class App {
  ...
  private addBookForm = document.getElementById(
    "addBookForm",
  ) as HTMLFormElement;
  private addUserForm = document.getElementById(
    "addUserForm",
  ) as HTMLFormElement;
  ...
  private bookTitleInput = document.getElementById(
    "bookTitle",
  ) as HTMLInputElement;
  private bookAuthorInput = document.getElementById(
    "bookAuthor",
  ) as HTMLInputElement;
  private bookYearInput = document.getElementById(
    "bookYear",
  ) as HTMLInputElement;
  private userNameInput = document.getElementById(
    "userName",
  ) as HTMLInputElement;
  private userEmailInput = document.getElementById(
    "userEmail",
  ) as HTMLInputElement;
  ...
  private handleAddBook(event: Event): void {
    ...
    const isAuthorValid = this.validateField(
      this.bookAuthorInput,
      Validation.isRequired,
    );
    const isYearValid = this.validateField(
      this.bookYearInput,
      Validation.isYear,
    );
